...
function AdminNav() {
  ...
  const handleLogout = () => {
    ...
    navigate("/das"); // Redirect to login page
  };
    ...
    <div className='max-w-screen border-zinc-200 shadow sahd'>
      ...
      {!open && (
        <div className='flex max-w-screen font-bold h-16 justify-between items-center px-5 sm:px-0'>
          <div className='flex  text-xl sm:pl-20'>
          <h2 className="flex w-56 items-center whitespace-nowrap">
          ...
          <h4 className=' sm:flex gap-8 hidden sm:pr-20 justify-center items-center'>
            <Link className='flex w-26 ' to='/admin'>Add Product</Link>
            <Link className='flex w-26 ' to='/products'> My Products</Link>
            <Link className='flex w-26 ' to='/das'> User Pannel</Link>
